...
RUN apt-get update && apt-get install php7.2-phalcon=3.4.2-2+php7.2 --no-install-recommends \
  && apt-mark hold php7.2-phalcon=3.4.2-2+php7.2 && rm -rf /var/lib/apt/lists/*
